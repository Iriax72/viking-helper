export class CardDeck extends Phaser.GameObjects.Container {
    constructor(scene, x, y, onCardChosen) {
        super(scene, x, y);
    ...
    createDeck() {
        ...
        // Texte indicatif
        this.deckText = this.scene.add.text(0, 0, 'DECK', {
            fontSize: '16px',
            color: '#ecf0f1',
            fontStyle: 'bold'
        }).setOrigin(0.5);
    ...
    drawCards() {
        ...
        this.card1 = this.createCard(centerX - 120, centerY, 'Carte 1', 0xe74c3c);
        this.card2 = this.createCard(centerX + 120, centerY, 'Carte 2', 0x3498db);
